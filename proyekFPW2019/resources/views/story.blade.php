...
{{ Form::open(array('url' => 'dashboard')) }}
	...
	<div class="navbar navbar-default" style="margin-top:-20px;height:10px ;background-color: #1998ed;">
		...
		<ul class="nav navbar-nav" style="color:white;">
			<li role="presentation" class="active" style="color:blue"><a href="#" style="margin-right:10px;margin-left:25px; "><strong style="color:white">STORY</strong></a></li>
			<li role="presentation" ><a href="#" style="margin-right:10px;"><strong style="color:white">HOBBY</strong></a></li>
			<li role="presentation" ><a href="#" style="margin-right:10px;"><strong style="color:white">GAMES</strong></a></li>
			<li role="presentation"><a href="#" style="margin-right:10px;"><strong style="color:white">ENTERTAINMENT</strong></a></li>
			<li role="presentation"><a href="#" style="margin-right:10px;"><strong style="color:white">FEMALE</strong></a></li>
			<li role="presentation"><a href="#" style="margin-right:10px;"><strong style="color:white">TECH</strong></a></li>
			<li role="presentation"><a href="#" style="margin-right:10px;"><strong style="color:white">AUTOMOTIVE</strong></a></li>
			<li role="presentation"><a href="#" style="margin-right:10px;"><strong style="color:white">SPORTS</strong></a></li>
			<li role="presentation"><a href="#" style="margin-right:10px;"><strong style="color:white">FOOD & TRAVEL</strong></a></li>
			<li role="presentation"><a href="#"><strong style="color:white">NEWS</strong></a></li>              
		</ul>
	</div>
	<div class="container">
		<div class="row">
